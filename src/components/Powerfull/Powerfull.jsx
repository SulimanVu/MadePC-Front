          ...
          <div className={styles.blockEnd}>
            <div className={styles.first}>
              ...
              <span>
                ...
                высокотехнологичные решения в мире IT. Мы постоянно следим за
                основными тенденциями мирового компьютерного рынка и предлагаем
                своим клиентам только лучшие образцы, на основе самых топовых
                компонентов и инновационных решений.
                <br />
                <br />
          ...
          <div className={styles.blockEnd}>
            <div className={styles.first}>
              ...
              <span>
                ...
                компании EDELWEISS. В магазине есть достаточное количество
